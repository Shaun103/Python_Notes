...
@dataclass
class Employee(ABC):
    """Basic representation of an employee should be paid"""
...
class SalariedEmployeeWithCommission(SalariedEmployee):
    ...
    def compute_pay(self) -> float:
        """Compute how much the employee should be paid."""
        return (super().compute_pay()  # duplicated code
            + self.commission * self.contracts_landed
        )
...
class FreelancerWithcommission(Freelancer):
    ...
    def compute_pay(self) -> float:
        """Compute how much the employee should be paid."""
        return (
            super().compute_pay() + self.commission * self.contracts_landed # duplicated code
        )
